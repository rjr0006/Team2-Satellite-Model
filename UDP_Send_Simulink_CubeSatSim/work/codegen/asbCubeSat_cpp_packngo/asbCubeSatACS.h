...
class asbCubeSatACS final
{
 ...
 public:
  ...
  struct RT_MODEL_asbCubeSatACS_T {
  ...
  asbCubeSatACS::RT_MODEL_asbCubeSatACS_T * getRTM();

  //member function to setup error status pointer
  void setErrorStatusPointer(const char_T **rt_errorStatus);

  // model step function
  void step(const real_T rtu_SensorsOut_X_eci[3], const real_T
            rtu_SensorsOut_V_eci[3], const real_T rtu_SensorsOut_q_eci2b[4],
            const real_T *rtu_AttitudeMode, const real_T
 ...
 private:
  ...
  static void asbCubeSatACS_IfActionSubsystem1(real_T *rty_Out1);

  // private member function(s) for subsystem '<S50>/If Action Subsystem2'
  static void asbCubeSatACS_IfActionSubsystem2(real_T *rty_Out1);
...
extern const asbCubeSatACS::ConstB_asbCubeSatACS_h_T asbCubeSatACS_ConstB;
