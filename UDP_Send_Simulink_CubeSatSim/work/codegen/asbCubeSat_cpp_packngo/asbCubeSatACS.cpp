...
// C/C++ source code generated on : Tue Sep 27 09:57:09 2022
//
...
//
void asbCubeSatACS::asbCubeSatACS_IfActionSubsystem1(real_T *rty_Out1)
{
...
//
void asbCubeSatACS::asbCubeSatACS_IfActionSubsystem2(real_T *rty_Out1)
{
     ...
     case asbCubeSatACS_IN_Earth:
      {
        if (*rtu_AttitudeMode == 2.0) {
          ...
          if (asbCubeSatACS_ConstB.Abs_m < 1.0E-6) {
            ...
            asbCubeSatACS_IfActionSubsystem1(&rtb_fcn5);
            ...
            asbCubeSatACS_IfActionSubsystem2(&rtb_fcn5);
          ...
          if (rtb_Product3_hi < 1.0E-6) {
            ...
            asbCubeSatACS_IfActionSubsystem1(&rtb_Product2_f5);
            ...
            asbCubeSatACS_IfActionSubsystem2(&rtb_Product2_f5);
          ...
          if (rtb_fcn5 < 1.0E-6) {
            ...
            asbCubeSatACS_IfActionSubsystem1(&rtb_Product3_hi);
            ...
            asbCubeSatACS_IfActionSubsystem2(&rtb_Product3_hi);
          ...
          if (std::abs(rtb_Product2_f5 + -1.0) < 1.0E-6) {
            ...
            asbCubeSatACS_IfActionSubsystem1(&rtb_fcn2);
            ...
            asbCubeSatACS_IfActionSubsystem2(&rtb_fcn2);
     ...
     case asbCubeSatACS_IN_Sun:
      {
        if (*rtu_AttitudeMode == 1.0) {
          ...
          if (rtb_fcn4 < 1.0E-6) {
            ...
            asbCubeSatACS_IfActionSubsystem1(&rtb_Merge_dw);
            ...
            asbCubeSatACS_IfActionSubsystem2(&rtb_Merge_dw);
