...
class asbCubeSatACS final
{
 ...
 public:
  ...
  struct P_IfActionSubsystem_asbCubeSatACS_T {
 ...
 private:
  ...
  // Tunable parameters
  static P_asbCubeSatACS_T asbCubeSatACS_rtP;
...
extern asbCubeSatACS::P_asbCubeSatACS_T asbCubeSatACS_rtP;
