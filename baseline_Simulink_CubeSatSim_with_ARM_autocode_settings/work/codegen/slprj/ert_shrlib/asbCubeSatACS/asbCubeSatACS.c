...
void asbCubeSatACS_Init(ACSOutBus *rty_ACSOut)
{
                   ...
                   B_asbCubeSatACS_c_T *localB, DW_asbCubeSatACS_f_T *localDW)
{
     ...
     case asbCubeSatACS_IN_Earth:
      {
        if (*rtu_AttitudeMode == 2.0) {
           ...
           */
          rtb_fcn2 = sqrt(((rtu_SensorsOut_q_eci2b[0] * rtu_SensorsOut_q_eci2b[0]
                            + -rtu_SensorsOut_q_eci2b[1] *
                            -rtu_SensorsOut_q_eci2b[1]) +
                           -rtu_SensorsOut_q_eci2b[2] * -rtu_SensorsOut_q_eci2b
                           [2]) + -rtu_SensorsOut_q_eci2b[3] *
           ...
           */
          rtb_Merge_dw = sqrt(((rtb_Product_he * rtb_Product_he + -rtb_Sum_g2 *
                                -rtb_Sum_g2) + -rtb_Sum_hk * -rtb_Sum_hk) +
           ...
           */
          rtb_Product3_hi = sqrt((rtu_SensorsOut_X_eci[0] *
           ...
           */
          rtb_Merge_dw = sqrt((rtb_fcn2 * rtb_fcn2 + rtb_fcn4 * rtb_fcn4) +
                              rtb_Product3_n4 * rtb_Product3_n4);

          /* Sqrt: '<S23>/|e|' incorporates:
           *  DotProduct: '<S23>/Dot Product4'
           */
          rtb_Sum_m = sqrt((rtb_is180degRot_p_idx_0 * rtb_is180degRot_p_idx_0 +
           ...
           */
          if (rtb_fcn4 >= 0.0) {
            rtb_Product3_hi = acos(fmax(-1.0, fmin(rtb_fcn2 / rtb_Merge_dw, 1.0)));
          } else {
            rtb_Product3_hi = 6.2831853071795862 - acos(fmax(-1.0, fmin(rtb_fcn2
              / rtb_Merge_dw, 1.0)));
          }
          ...
          if (rtb_is180degRot_p_idx_2 >= 0.0) {
            rtb_fcn5 = acos(fmax(-1.0, fmin(((rtb_fcn2 * rtb_is180degRot_p_idx_0
              + rtb_fcn4 * rtb_is180degRot_p_idx_1) + rtb_Product3_n4 *
              rtb_is180degRot_p_idx_2) / (rtb_Merge_dw * rtb_Sum_m), 1.0)));
          } else {
            rtb_fcn5 = 6.2831853071795862 - acos(fmax(-1.0, fmin(((rtb_fcn2 *
          ...
          if ((rtu_SensorsOut_X_eci[0] * rtu_SensorsOut_V_eci[0] +
            ...
            rtb_fcn2 = acos(fmax(-1.0, fmin(((rtb_is180degRot_p_idx_0 *
              rtu_SensorsOut_X_eci[0] + rtb_is180degRot_p_idx_1 *
              rtu_SensorsOut_X_eci[1]) + rtb_is180degRot_p_idx_2 *
              rtu_SensorsOut_X_eci[2]) / rtb_Product1_fn, 1.0)));
          } else {
            rtb_fcn2 = 6.2831853071795862 - acos(fmax(-1.0, fmin
          ...
          rtb_is180degRot_p_idx_1 = acos(fmax(-1.0, fmin(rtb_Product2_l5 / sqrt
            ((rtb_Product3_pr * rtb_Product3_pr + rtb_Product2_f5 *
              rtb_Product2_f5) + rtb_Product2_l5 * rtb_Product2_l5), 1.0))) *
            0.5;
          rtb_is180degRot_p_idx_2 = (rtb_fcn5 + rtb_fcn2) * 0.5;

          /* Trigonometry: '<S33>/sincos' */
          rtb_fcn2 = cos(rtb_is180degRot_p_idx_0);
          rtb_Product3_pr = sin(rtb_is180degRot_p_idx_0);
          rtb_fcn4 = cos(rtb_is180degRot_p_idx_1);
          rtb_Merge_dw = sin(rtb_is180degRot_p_idx_1);
          rtb_Product3_n4 = cos(rtb_is180degRot_p_idx_2);
          rtb_Product2_f5 = sin(rtb_is180degRot_p_idx_2);
           ...
           *  Sum: '<S37>/Sum'
           */
          rtb_Sum_m = sqrt(((rtb_Product3_hi * rtb_Product3_hi + rtb_fcn5 *
                             rtb_fcn5) + rtb_Merge_dw * rtb_Merge_dw) +
                           rtb_Product3_pr * rtb_Product3_pr);
           ...
           */
          rtb_Merge_dw = sqrt(((rtb_Product3_hi * rtb_Product3_hi +
                                -rtb_Product3_n4 * -rtb_Product3_n4) + -rtb_fcn2
                               * -rtb_fcn2) + -rtb_Product2_f5 *
                              -rtb_Product2_f5);
          ...
          rtb_Product2_f5 = ((rtb_Product1_g * rtb_Product3_pr + rtb_Sum *
                              rtb_Merge_dw) + rtb_Sum_ft * rtb_fcn4) / sqrt
           ...
           *  Bias: '<S51>/Bias'
           */
          rtb_Product3_hi = fabs(rtb_Product2_f5 + -1.0);

          /* Abs: '<S51>/Abs1' incorporates:
           *  Bias: '<S51>/Bias1'
           */
          rtb_Product2_f5 = fabs(rtb_Product2_f5 + 1.0);
           ...
           *  Sqrt: '<S56>/Sqrt3'
           */
          rtb_Product2_f5 = sqrt(rtb_fcn2 * asbCubeSatACS_ConstB.DotProduct1_hl)
            + rtb_Product3_n4;
           ...
           *  Sqrt: '<S77>/Sqrt3'
           */
          rtb_Product3_hi = rtb_Product3_n4 / sqrt(rtb_fcn2 *
            asbCubeSatACS_ConstB.DotProduct1_p);

          /* Abs: '<S77>/Abs' incorporates:
           *  Bias: '<S77>/Bias'
           */
          rtb_fcn5 = fabs(rtb_Product3_hi + -1.0);

          /* Abs: '<S77>/Abs1' incorporates:
           *  Bias: '<S77>/Bias1'
           */
          rtb_Product3_hi = fabs(rtb_Product3_hi + 1.0);
           ...
           *  Sum: '<S90>/Sum'
           */
          rtb_Product3_hi = sqrt(((rtb_Product2_f5 * rtb_Product2_f5 +
           ...
           *  Sum: '<S75>/Sum'
           */
          rtb_Product2_f5 = sqrt(((rtb_Product2_l5 * rtb_Product2_l5 + rtb_Sum *
            rtb_Sum) + rtb_Product1_g * rtb_Product1_g) + rtb_Sum_ft *
            rtb_Sum_ft);
          ...
          rtb_Product2_f5 = ((asbCubeSatACS_ConstB.Sum_e[0] * rtb_Merge_dw +
            ...
            sqrt(((rtb_Merge_dw * rtb_Merge_dw + rtb_Product3_pr *
           ...
           *  Bias: '<S92>/Bias1'
           */
          if (fabs(rtb_Product2_f5 + -1.0) < 1.0E-6) {
          ...
          } else if (fabs(rtb_Product2_f5 + 1.0) < 1.0E-6) {
          ...
          if (rtb_Compare || rtb_Compare_jn) {
            localB->cmd_q_b2tgt[0] = rtb_Product2_l5;
            localB->cmd_q_b2tgt[1] = rtb_Sum;
            localB->cmd_q_b2tgt[2] = rtb_Product1_g;
            localB->cmd_q_b2tgt[3] = rtb_Sum_ft;
          } else {
            if (rtb_fcn2 != -1.0) {
             ...
             *  Sum: '<S107>/Sum'
             */
            rtb_Product3_hi = sqrt(((rtb_Merge_dw * rtb_Merge_dw +
             ...
             *  Sum: '<S105>/Sum'
             */
            rtb_fcn5 = sqrt(((rtb_Product3_hi * rtb_Product3_hi + rtb_fcn2 *
            ...
            localB->cmd_q_b2tgt[0] = ((rtb_Product2_l5 * rtb_Product3_hi -
              rtb_Sum * rtb_fcn2) - rtb_Product1_g * rtb_fcn4) - rtb_Sum_ft *
              rtb_Product3_n4;
            localB->cmd_q_b2tgt[1] = ((rtb_Product2_l5 * rtb_fcn2 + rtb_Sum *
              rtb_Product3_hi) + rtb_Product1_g * rtb_Product3_n4) - rtb_Sum_ft *
              rtb_fcn4;
            localB->cmd_q_b2tgt[2] = ((rtb_Product2_l5 * rtb_fcn4 - rtb_Sum *
              rtb_Product3_n4) + rtb_Product1_g * rtb_Product3_hi) + rtb_Sum_ft *
              rtb_fcn2;
            localB->cmd_q_b2tgt[3] = ((rtb_Product2_l5 * rtb_Product3_n4 +
           ...
           *  Sum: '<S135>/Sum'
           */
          rtb_Product2_f5 = sqrt(((localB->cmd_q_b2tgt[0] * localB->cmd_q_b2tgt
            [0] + localB->cmd_q_b2tgt[1] * localB->cmd_q_b2tgt[1]) +
            localB->cmd_q_b2tgt[2] * localB->cmd_q_b2tgt[2]) +
            localB->cmd_q_b2tgt[3] * localB->cmd_q_b2tgt[3]);

          /* Product: '<S129>/Product' */
          rtb_Product3_hi = localB->cmd_q_b2tgt[0] / rtb_Product2_f5;

          /* Product: '<S129>/Product1' */
          rtb_fcn5 = localB->cmd_q_b2tgt[1] / rtb_Product2_f5;

          /* Product: '<S129>/Product2' */
          rtb_Merge_dw = localB->cmd_q_b2tgt[2] / rtb_Product2_f5;

          /* Product: '<S129>/Product3' */
          rtb_Product2_f5 = localB->cmd_q_b2tgt[3] / rtb_Product2_f5;
           ...
           *  Merge: '<S3>/ Merge '
           */
          localB->PointingCmd[0] = rt_atan2d_snf((rtb_Merge_dw * rtb_Product2_f5
            - rtb_Product3_hi * rtb_fcn5) * -2.0, ((rtb_Sum - rtb_fcn2) -
            rtb_fcn4) + rtb_Product3_n4);
           ...
           *  Merge: '<S3>/ Merge '
           */
          localB->PointingCmd[2] = rt_atan2d_snf((rtb_fcn5 * rtb_Merge_dw -
            rtb_Product3_hi * rtb_Product2_f5) * -2.0, ((rtb_Sum + rtb_fcn2) -
            rtb_fcn4) - rtb_Product3_n4);
           ...
           *  Merge: '<S3>/ Merge '
           */
          localB->PointingCmd[1] = asin(rtb_Product1_g);
        }
      }
      break;
     ...
     case asbCubeSatACS_IN_Sun:
      {
        if (*rtu_AttitudeMode == 1.0) {
           ...
           */
          rtb_Product3_pr = sqrt(((rtu_SensorsOut_q_eci2b[0] *
           ...
           */
          rtb_Product3_pr = sqrt(((rtb_fcn2 * rtb_fcn2 + -rtb_Product1_g *
           ...
           *  UnaryMinus: '<S152>/Unary Minus2'
           */
          rtb_fcn5 = sqrt(((rtb_fcn2 * rtb_fcn2 + -rtb_Product1_g *
                            -rtb_Product1_g) + -rtb_Product2_l5 *
                           -rtb_Product2_l5) + -rtb_Product3_n4 *
                          -rtb_Product3_n4);
          ...
          rtb_Merge_dw = ((rtb_Sum * rtb_Product1_g + rtb_Sum_ft * rtb_fcn5) +
                          rtb_Sum_m * rtb_Product2_f5) / sqrt(((rtb_Product1_g *
            rtb_Product1_g + rtb_fcn5 * rtb_fcn5) + rtb_Product2_f5 *
            rtb_Product2_f5) * rtb_Product3_pr);

          /* Abs: '<S157>/Abs' incorporates:
           *  Bias: '<S157>/Bias'
           */
          rtb_fcn4 = fabs(rtb_Merge_dw + -1.0);

          /* Abs: '<S157>/Abs1' incorporates:
           *  Bias: '<S157>/Bias1'
           */
          rtb_Merge_dw = fabs(rtb_Merge_dw + 1.0);
           ...
           *  Sqrt: '<S162>/Sqrt3'
           */
          rtb_Product3_hi = sqrt(rtb_Product3_pr *
           ...
           *  Sqrt: '<S183>/Sqrt3'
           */
          rtb_Merge_dw = rtb_fcn2 / sqrt(rtb_Product3_pr *
           ...
           *  Sum: '<S196>/Sum'
           */
          rtb_Merge_dw = sqrt(((rtb_Product3_hi * rtb_Product3_hi + rtb_fcn2 *
                                rtb_fcn2) + rtb_fcn4 * rtb_fcn4) +
                              rtb_Product3_n4 * rtb_Product3_n4);
           ...
           *  Sum: '<S181>/Sum'
           */
          rtb_Product3_hi = sqrt(((rtb_Product_he * rtb_Product_he + rtb_Sum_ft *
            rtb_Sum_ft) + rtb_Sum * rtb_Sum) + rtb_Sum_m * rtb_Sum_m);
          ...
          rtb_Product3_hi = (asbCubeSatACS_ConstB.Sum_i[2] * rtb_fcn5 +
                             rtb_Product3_pr) / sqrt((rtb_fcn5 * rtb_fcn5 +
           ...
           *  Bias: '<S198>/Bias1'
           */
          if (fabs(rtb_Product3_hi + -1.0) < 1.0E-6) {
          ...
          } else if (fabs(rtb_Product3_hi + 1.0) < 1.0E-6) {
           ...
           */
          if (rtb_Compare || rtb_Compare_jn) {
            localB->cmd_q_b2tgt[0] = rtb_Product_he;
            localB->cmd_q_b2tgt[1] = rtb_Sum_ft;
            localB->cmd_q_b2tgt[2] = rtb_Sum;
            localB->cmd_q_b2tgt[3] = rtb_Sum_m;
          } else {
            if (rtb_fcn2 != -1.0) {
             ...
             *  Sum: '<S213>/Sum'
             */
            rtb_Product3_hi = sqrt((rtb_fcn5 * rtb_fcn5 +
            ...
            rtb_Product3_hi /= rtb_fcn5;
            localB->cmd_q_b2tgt[0] = ((rtb_Product_he * rtb_Product3_hi -
              rtb_Sum_ft * rtb_fcn2) - rtb_Sum * rtb_fcn4) - rtb_Sum_m *
              rtb_Product3_n4;
            localB->cmd_q_b2tgt[1] = ((rtb_Product_he * rtb_fcn2 + rtb_Sum_ft *
              rtb_Product3_hi) + rtb_Sum * rtb_Product3_n4) - rtb_Sum_m *
              rtb_fcn4;
            localB->cmd_q_b2tgt[2] = ((rtb_Product_he * rtb_fcn4 - rtb_Sum_ft *
              rtb_Product3_n4) + rtb_Sum * rtb_Product3_hi) + rtb_Sum_m *
              rtb_fcn2;
            localB->cmd_q_b2tgt[3] = ((rtb_Product_he * rtb_Product3_n4 +
           ...
           *  Sum: '<S241>/Sum'
           */
          rtb_Product3_hi = sqrt(((localB->cmd_q_b2tgt[0] * localB->cmd_q_b2tgt
            [0] + localB->cmd_q_b2tgt[1] * localB->cmd_q_b2tgt[1]) +
            localB->cmd_q_b2tgt[2] * localB->cmd_q_b2tgt[2]) +
            localB->cmd_q_b2tgt[3] * localB->cmd_q_b2tgt[3]);

          /* Product: '<S235>/Product' */
          rtb_fcn5 = localB->cmd_q_b2tgt[0] / rtb_Product3_hi;

          /* Product: '<S235>/Product1' */
          rtb_Product1_g = localB->cmd_q_b2tgt[1] / rtb_Product3_hi;

          /* Product: '<S235>/Product2' */
          rtb_Product2_f5 = localB->cmd_q_b2tgt[2] / rtb_Product3_hi;

          /* Product: '<S235>/Product3' */
          rtb_Product3_hi = localB->cmd_q_b2tgt[3] / rtb_Product3_hi;
           ...
           *  Merge: '<S3>/ Merge '
           */
          localB->PointingCmd[0] = rt_atan2d_snf((rtb_Product2_f5 *
           ...
           *  Merge: '<S3>/ Merge '
           */
          localB->PointingCmd[2] = rt_atan2d_snf((rtb_Product1_g *
           ...
           *  Merge: '<S3>/ Merge '
           */
          localB->PointingCmd[1] = asin(rtb_Product3_pr);
        }
      }
      break;
     ...
     default:
      {
        ...
        if (*rtu_AttitudeMode == 1.0) {
           ...
           *  UnaryMinus: '<S118>/Unary Minus2'
           */
          rtb_Merge_dw = sqrt(((rtb_fcn4 * rtb_fcn4 + -rtb_Product3_hi *
                                -rtb_Product3_hi) + -rtb_Product3_n4 *
                               -rtb_Product3_n4) + -rtb_fcn2 * -rtb_fcn2);
           ...
           *  Product: '<S23>/divide'
           */
          rtb_Merge_dw = fmin(rtb_fcn2 / rtb_Merge_dw, 1.0);
           ...
           */
          if (rtb_fcn4 >= 0.0) {
            rtb_Product3_hi = acos(fmax(-1.0, fmin(rtb_Product3_hi, 1.0)));
          } else {
            rtb_Product3_hi = 6.2831853071795862 - acos(fmax(-1.0, rtb_Merge_dw));
          }
           ...
           *  UnaryMinus: '<S8>/Unary Minus2'
           */
          rtb_Sum_m = sqrt(((rtu_SensorsOut_q_eci2b[0] * rtu_SensorsOut_q_eci2b
                             [0] + -rtu_SensorsOut_q_eci2b[1] *
                             -rtu_SensorsOut_q_eci2b[1]) +
                            -rtu_SensorsOut_q_eci2b[2] *
                            -rtu_SensorsOut_q_eci2b[2]) +
                           -rtu_SensorsOut_q_eci2b[3] * -rtu_SensorsOut_q_eci2b
                           [3]);
          ...
          rtb_Product2_f5 = ((0.0 * rtb_Product1_g + 0.0 * rtb_Sum) + rtb_Sum_ft)
            + sqrt(rtb_Product_he * asbCubeSatACS_ConstB.DotProduct1_hl);
          ...
          rtb_Product3_hi = ((0.0 * rtb_Product1_g + 0.0 * rtb_Sum) + rtb_Sum_ft)
            / sqrt(((rtb_Product1_g * rtb_Product1_g + rtb_fcn2) + rtb_Sum_m) *
                   asbCubeSatACS_ConstB.DotProduct1_p);
           ...
           */
          localB->PointingCmd[0] = rt_atan2d_snf((rtb_Merge_dw * rtb_Product2_f5
            - rtb_Product3_hi * rtb_fcn5) * -2.0, ((rtb_fcn2 - rtb_fcn4) -
            rtb_Product3_n4) + rtb_Sum);
           ...
           */
          localB->PointingCmd[2] = rt_atan2d_snf((rtb_fcn5 * rtb_Merge_dw -
            rtb_Product3_hi * rtb_Product2_f5) * -2.0, ((rtb_fcn2 + rtb_fcn4) -
            rtb_Product3_n4) - rtb_Sum);
           ...
           *  UnaryMinus: '<S152>/Unary Minus2'
           */
          rtb_Merge_dw = sqrt(((rtb_fcn2 * rtb_fcn2 + -rtb_Product1_g *
                                -rtb_Product1_g) + -rtb_Product2_l5 *
                               -rtb_Product2_l5) + -rtb_Product3_n4 *
                              -rtb_Product3_n4);
          ...
          rtb_Merge_dw = ((rtb_Sum * rtb_Product1_g + rtb_Sum_ft * rtb_fcn5) +
                          rtb_Sum_m * rtb_Product2_f5) / sqrt(((rtb_Product1_g *
            rtb_Product1_g + rtb_fcn5 * rtb_fcn5) + rtb_Product2_f5 *
            rtb_Product2_f5) * (rtb_Sum_m * rtb_Sum_m + rtb_Product2_l5));
           ...
           *  Sqrt: '<S162>/Sqrt3'
           */
          rtb_Product3_hi = sqrt(rtb_is180degRot_p_idx_0 *
           ...
           *  Sqrt: '<S183>/Sqrt3'
           */
          rtb_Merge_dw = rtb_Product3_pr / sqrt(rtb_is180degRot_p_idx_0 *
            asbCubeSatACS_ConstB.DotProduct1_f);
          ...
          rtb_Product3_hi = ((asbCubeSatACS_ConstB.Sum_i[0] * rtb_Sum_g2 +
                              asbCubeSatACS_ConstB.Sum_i[1] * rtb_Sum_hk) +
                             asbCubeSatACS_ConstB.Sum_i[2] * rtb_fcn5) / sqrt
            (((rtb_Sum_g2 * rtb_Sum_g2 + rtb_Sum_hk * rtb_Sum_hk) + rtb_fcn5 *
          ...
          if (rtb_Compare || rtb_Compare_jn) {
             ...
             *  Sum: '<S213>/Sum'
             */
            rtb_Product3_hi = sqrt(((rtb_Sum_g2 * rtb_Sum_g2 + rtb_Sum_hk *
   ...
   *  automatically.
   */
  rtb_fcn2 = 0.017 * localB->PointingCmd[0];
   ...
   *  Sum: '<S284>/Sum'
   */
  rty_ACSOut->TorqueCmds[0] = (5.5E-5 * localB->PointingCmd[0] +
    localDW->Integrator_DSTATE[0]) + (rtb_fcn2 - localDW->UD_DSTATE[0]);
   ...
   */
  rtb_Product3_pr = rtb_fcn2;
  rtb_fcn2 = 0.017 * localB->PointingCmd[1];
   ...
   *  Sum: '<S284>/Sum'
   */
  rty_ACSOut->TorqueCmds[1] = (5.5E-5 * localB->PointingCmd[1] +
    localDW->Integrator_DSTATE[1]) + (rtb_fcn2 - localDW->UD_DSTATE[1]);
  ...
  rtb_fcn2 = 0.017 * localB->PointingCmd[2];
   ...
   *  Sum: '<S284>/Sum'
   */
  rty_ACSOut->TorqueCmds[2] = (5.5E-5 * localB->PointingCmd[2] +
    localDW->Integrator_DSTATE[2]) + (rtb_fcn2 - localDW->UD_DSTATE[2]);
   ...
   *  Merge: '<S3>/ Merge '
   */
  localDW->Integrator_DSTATE[0] += 0.0 * localB->PointingCmd[0];
   ...
   *  automatically.
   */
  localDW->UD_DSTATE[0] = rtb_Product3_pr;

  /* Update for DiscreteIntegrator: '<S275>/Integrator' incorporates:
   *  Gain: '<S272>/Integral Gain'
   *  Merge: '<S3>/ Merge '
   */
  localDW->Integrator_DSTATE[1] += 0.0 * localB->PointingCmd[1];
   ...
   *  automatically.
   */
  localDW->UD_DSTATE[1] = rtb_Product2_f5;

  /* Update for DiscreteIntegrator: '<S275>/Integrator' incorporates:
   *  Gain: '<S272>/Integral Gain'
   *  Merge: '<S3>/ Merge '
   */
  localDW->Integrator_DSTATE[2] += 0.0 * localB->PointingCmd[2];

  /* Update for Delay: '<S268>/UD' */
  localDW->UD_DSTATE[2] = rtb_fcn2;
}
