...
## Generated on : Wed Sep 28 19:53:24 2022
...
INCLUDES_BUILDINFO = -I$(START_DIR)/slprj/ert/asbCubeSatACS -I$(START_DIR) -I$(START_DIR)/asbCubeSat_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
SRCS = $(START_DIR)/asbCubeSat_ert_rtw/asbCubeSat.cpp $(START_DIR)/asbCubeSat_ert_rtw/asbCubeSat_data.cpp
...
OBJS = asbCubeSat.cpp.o asbCubeSat_data.cpp.o
